 ...
 class Ganesh {
	...
	public static void main(String[] args) {
		List<Fruits> fru=Arrays.asList(
  		      ...
  		      new Fruits("Apple",98, 45, "Red"),
  		      new Fruits("Banana",102, 30,"Yellow"),
  		      new Fruits("Strwabeery", 120, 55, "Red"),
  		      new Fruits("Blackberry", 78, 34, "Black")
  			);
		

		
		List<The_news> news1=Arrays.asList(
    			
	  		      new The_news(22, "Navin", "Asha", " the new budget lis is good"),
	  		      new The_news(23, "Venky", "naga", "Finally ipl Started"),
	  		      new The_news(23, "Venky", "Naga","I supported to MI "),
	  		      new The_news(24, "Ashish", "Narhsa", "wbu 12 exam"),
	  		      new The_news(22, "Navin", "Yallesh", "without budget list face too much problem"),
	  		      new The_news(23, "Venky", "Naga","ipl india ka festival")
	  			);
		...
		List<Transaction_Details> Tran =Arrays.asList(
    			
	  		      new Transaction_Details(new Trader("Chichya","Pune"),2014,20000 ),
	  		      new Transaction_Details(new Trader("Chintu", "Mumbai"), 2012, 21000),
	  		      new Transaction_Details(new Trader("Akash","Delhi"), 2019, 70000),
	  		      new Transaction_Details( new Trader("Amol","Pune"), 2017, 22222),
	  		      new Transaction_Details(new Trader("Rohan","Delhi"), 2014, 19999),
	  		      new Transaction_Details(new Trader("Sagar","Pune"), 2015, 17000)
	  			);
